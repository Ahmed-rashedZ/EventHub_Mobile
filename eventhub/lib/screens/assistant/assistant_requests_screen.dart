...
class _AssistantRequestsScreenState extends State<AssistantRequestsScreen> {
  ...
  void _respond(int requestId, String status) async {
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Row(
            children: [
              ...
              Text(
                Provider.of<LanguageProvider>(context, listen: false).translate('reject_invitation'),
                style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
              ),
            ],
          ),
          content: Text(
            Provider.of<LanguageProvider>(context, listen: false).translate('reject_invitation_msg'),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: Text(
                Provider.of<LanguageProvider>(context, listen: false).translate('reject'),
    ...
    if (error != null) {
      ...
      final msg = status == 'accepted' ? language.translate('invitation_accepted') : language.translate('invitation_rejected');
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(language.translate('no_pending_requests'), style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textMuted)),
  ...
  Widget _buildRequestCard(Map<String, dynamic> req, LanguageProvider language) {
    ...
    final months = [
      language.translate('jan'), language.translate('feb'), language.translate('mar'),
      language.translate('apr'), language.translate('may'), language.translate('jun'),
      language.translate('jul'), language.translate('aug'), language.translate('sep'),
      language.translate('oct'), language.translate('nov'), language.translate('dec')
    ];
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                _infoRow(Icons.person_outline_rounded, '${language.translate('from')} $managerName'),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              const Icon(Icons.close_rounded, size: 20, color: AppColors.danger),
                              const SizedBox(width: 6),
                              Text(language.translate('reject'), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.danger)),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 6),
                              Text(language.translate('accept'), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                            ],
                          ),
                        ),
                      ),
